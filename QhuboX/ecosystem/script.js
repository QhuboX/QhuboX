...
──────────────────────────────────────────── */
const APPS = [
  { id: 'QhronoX Protocol', icon: '🕐', color: '#7b2ff7', img: '/imahe/c.png',
  ...
  { id: 'sAIgnalX', icon: '📊', color: '#00d2ff', img: 'icons/analytics.png',
    url: 'ecosystem/sAIgnalX/sAIgnalX.html',
  ...
  { id: 'Sollower', icon: '🌿', color: '#28ca41', img: 'icons/Dao.png',
    ...
    category: 'Social' },
  { id: 'Burnow', icon: '🔥', color: '#ff7b00', img: '/imahe/Gem.png',
    url: '/ecosystem/Burn/Burnallin.html',
  ...
  { id: 'NeuroQhuboX', icon: '🧠', color: '#ff6b9d', img: 'media/neuro.png',
    ...
    category: 'AI' },
  { id: 'DEV Turing', icon: '🤖', color: '#64b4ff', img: '/imahe/m.png',
  ...
  { id: 'Kiaraap', icon: '💜', color: '#9966ff', img: 'icons/wallet.png',
    url: '/ecosystem/Kiaraap/KIARA.html',
